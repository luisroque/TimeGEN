...
class NBEATSBlockLatent(nn.Module):
    ...
    def __init__(
        ...
        total_input_size = input_size + z_proj_out  # extra from latent_z
...
class NHITSBlockLatent(nn.Module):
    ...
    def __init__(
        ...
        total_input_size = (
            ...
            + stat_input_size
            + z_proj_out  # extra from latent_z
        )
...
class TimeGEN_HT(TimeGEN_S):
    ...
    def __init__(
        ...
        **trainer_kwargs,
        ...
        super(TimeGEN_HT, self).__init__(
            h=h,
        ...
        blocks = self._create_universal_stack_z_proj_out(
            h=h,
            input_size=input_size,
            ...
            latent_dim=latent_dim,
            z_proj_out=z_proj_out,
        )
        self.blocks = nn.ModuleList(blocks)

        self.z_proj = nn.Sequential(nn.Linear(latent_dim, z_proj_out), nn.Tanh())

    def _create_universal_stack_z_proj_out(
        self,
        h,
        input_size,
        futr_input_size,
