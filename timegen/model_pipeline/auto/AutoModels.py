...
class AutoTimeGEN_H(BaseAuto):
    ...
    def __init__(
        ...
        super(AutoTimeGEN_H, self).__init__(
            cls_model=TimeGEN_H,
            h=h,
            loss=loss,
            valid_loss=valid_loss,
...
class AutoTimeGEN_HT(BaseAuto):
    ...
    def __init__(
        ...
        super(AutoTimeGEN_HT, self).__init__(
            cls_model=TimeGEN_HT,
            h=h,
            loss=loss,
            valid_loss=valid_loss,
            config=config,
...
class AutoTimeGEN_MT(BaseAuto):
    ...
    def __init__(
        ...
        super(AutoTimeGEN_MT, self).__init__(
            cls_model=TimeGEN_MT,
            h=h,
            loss=loss,
            valid_loss=valid_loss,
            config=config,
...
class AutoTimeGEN_Z(BaseAuto):
    ...
    def __init__(
        ...
        super(AutoTimeGEN_Z, self).__init__(
            cls_model=TimeGEN_Z,
            h=h,
            loss=loss,
            valid_loss=valid_loss,
...
class AutoTimeGEN_ZZ(BaseAuto):
    ...
    default_config = {
        ...
        "z_proj_out": tune.choice([64, 128, 256]),
        "encoder_hidden_dims": tune.choice(
            [[64, 32], [256, 128], [512, 256], [512, 256, 128]]
        ),
        # NHITS params
    ...
    def __init__(
        ...
        super(AutoTimeGEN_ZZ, self).__init__(
            cls_model=TimeGEN_ZZ,
            h=h,
            loss=loss,
            valid_loss=valid_loss,
            config=config,
