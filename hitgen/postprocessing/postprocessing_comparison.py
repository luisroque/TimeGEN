...
def process_transformations(input_dict):
    ...
    for transformation, values in input_dict.items():
        ...
        reconstruction_error = {
            ...
            "reconstruction_error_hitgen": np.round(reconstruction_kl_l_gta[0], 3),
...
def create_reconstruction_error_percentage_dataset(data_dict):
    ...
    for transformation, stats in data_dict.items():
        ...
        hitgen_error = stats["reconstruction_error"]["reconstruction_error_hitgen"]
        hitgen_percentage_of_original = np.round((hitgen_error / original_error) * 100, 1)
        ...
        reconstruction_rows.append(
            {
                ...
                "Reconstruction Error % of Original": hitgen_percentage_of_original,
            }
        )
        reconstruction_rows.append(
            {
