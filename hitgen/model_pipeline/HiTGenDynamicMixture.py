...
class HiTGenDynamicMixture(HiTGenDeepMixture):
    """
    A variant of HiTGen that lets you specify how many blocks are N-HiTS vs. N-BEATS
    based on a tunable param and also if the VAE is deeply connected to each block or not
    """
    ...
    def __init__(
        ...
        **trainer_kwargs,
        ...
        super(HiTGenDynamicMixture, self).__init__(
            h=h,
